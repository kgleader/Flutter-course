...
import 'package:sabak9_f4/users.dart';
...
void main() {
  runApp(
    const MeninTirkemem(title: 8), // MininTirkemem
  );
}
...
class MeninTirkemem extends StatelessWidget {
  ...
  const MeninTirkemem({Key? key, required this.title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      // MaterialApp - бул Flutterдеги жогорку деңгээлдеги виджет. Бул болсо тиркемеге материалдык дизайнга тиешелүү өзгөчөлүктөрдү жана стилдерди кошот. Биз Flutter SDK тарабынан берилген бардык башка компоненттерге жана виджеттерге кире алат.
